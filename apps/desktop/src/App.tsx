    ...
    logs: [
      {
        ...
        lines: [
          ...
          ".\\scripts\\Install-AgentSystem.ps1 is the next step",
        ],
      },
    ],
    videoAutomation: {
    ...
    logs: [
      {
        ...
        lines: [
          ...
          "Install command remains outside the UI boundary.",
        ],
      },
    ],
    videoAutomation: {
    ...
    logs: [
      {
        ...
        lines: [
          ...
          ".\\bin\\agent-system.ps1 start is the next non-privileged action",
        ],
      },
    ],
    videoAutomation: {
...
function App() {
  ...
  const runRealProbe = async () => {
    ...
    setProbeError(null);
    try {
      const probe = await invoke<BackendProbe>("probe_backend_action", {
          ...
          <section className="grid two-up">
            <article className="panel">
              ...
              <ul className="stack-list">
                <li>React and TypeScript UI is wired for seven core views.</li>
          ...
          <section className="grid two-up">
            <article className="panel">
              <div className="section-header">
                <h3>Preflight and status contract</h3>
